<template>
    <b-modal
        id="directory-contracts-supply-modal-add"
        ref="directory-contracts-supply-modal-add"
        centered 
        content-class="c-modal-default directory-contracts"
        @shown="mountedData"
    >
        <template #modal-header>
            <h5>Создать договор поставки</h5>
        ...
        <div class="c-body">
                ...
                <b-col cols="6">
                    <b-row>
                        <b-col cols="12">
                            ...
                            <b-form-invalid-feedback v-if="!$v.form.amount.money & !$v.form.amount.required == false" id="input-amount-feedback">
            ...
            <b-row class="mt-4">
                ...
                <b-col cols="6">
                    <label class="label-custom">Выберите спецификацию</label>
                    <multiselect 
...
<script>
    ...
    export default {
        name: 'DirectoryContractsSupplyModalAdd',
        data() {
            return {
                form: {
                    specifications: [],
        ...
        methods: {
            ...
            hideModal(){
                this.$refs['directory-contracts-supply-modal-add'].hide();
            },
            mountedData(){
