...
export const statusInvoices = [
   ...
   { value: 'supplied', text: 'поставляется' },
   { value: 'accepted', text: 'принято частично' },
   { value: 'accepted-party', text: 'согласование' },
   { value: 'agreement', text: 'cогласование' },
   { value: 'canceled', text: 'отменена' },
]

export const statusDelivery = [
   { value: 'shipped', text: 'Поставляется' },
   { value: 'confirmend', text: 'Прниято' },
   { value: 'partially confirmend', text: 'Частично принято' },
]
