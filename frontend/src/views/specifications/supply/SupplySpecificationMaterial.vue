<template>
    <div class="c-specification-wrapper">
        <div v-if="supplySpecificationLoading" class="c-spinner_wrapper" style="height: 90vh">
        ...
        <div v-else class="c-specification-wrapper__content">
            <ve-table
                ...
                :columns="columns" 
                :table-data="supplySpecificationMaterialList"
                border-y
            />
        </div>
    </div>
...
<script>
    ...
    export default {
        name: 'SupplySpecificationMaterial',
        data(){ 
            return {
                columns: [
                    {
        ...
        watch: {
            '$props.selectIZMId': {
                async handler() {
                    await this.supplySpecificationMaterialSetList(this.selectIZMId)
        ...
        methods: {
            ...mapActions({
                ...
                supplySpecificationMaterialSetList: 'supplySpecificationMaterialSetListActions',
            })
        },
        computed: {
            ...mapGetters({
                supplySpecificationLoading: 'supplySpecificationLoadingGetter',
                supplySpecificationMaterialList: 'supplySpecificationMaterialListGetter',
