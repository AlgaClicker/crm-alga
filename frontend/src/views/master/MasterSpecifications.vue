            ...
            <div class="c-default-table-container">
                ...
                <div class="c-default-table">
                    ...
                    <div class="c-default-table__body">
                        <div v-if="masterSpecificationLoading" class="c-spinner_wrapper c-empty-table">
                        ...
                        <div 
                            v-else-if="masterSpecificationList.length == 0 | masterSpecificationList == null"
                            class="c-empty-table"
                        >
                        ...
                        <table v-else>
                            <tbody>
                                <tr v-for="item in masterSpecificationList" :key="item?.id">
    ...
    export default {
        ...
        computed: {
            ...mapGetters({
                ...
                masterSpecificationLoading: 'masterSpecificationLoadingGetter'
            }),
        },
        methods: {
            ...mapActions({
