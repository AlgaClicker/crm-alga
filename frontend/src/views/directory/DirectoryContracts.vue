    ...
    <div class='default-wrapper'>
        <div class="default-wrapper__header">
            ...
            <div class="left-container">
                <button @click="showModal('supply')" class="c-button-add mr-1">
                    <b-icon icon="plus-lg" scale="1"></b-icon>
                    <span> Договор поставки </span>
                </button>
                <button @click="showModal('construction')" class="c-button-add">
                    <b-icon icon="plus-lg" scale="1"></b-icon>
...
<script>
    ...
    import DirectoryContractsModalAdd from '@/components/directory/DirectoryContractsModalAdd'
    import DirectoryContractsModalInfo from '@/components/directory/DirectoryContractsModalInfo'
    ...
    export default {
        ...
        components: {
            ...
            DirectoryContractsModalAdd,
            DirectoryContractsModalInfo,
        },
        computed: {
            ...mapGetters({
        ...
        methods: {
            ...
            selectContract(contract){
                ...
                this.$bvModal.show('directory-contracts-modal-info')
            },
            showModal(type){
                if(this.profile.roles.service == 'snabzenie'){
                    this.type = 'supply'
                } else {
                    this.type = type
                }

                this.$bvModal.show('directory-contracts-modal-add')
            }
        },
        async mounted() {
            await this.directoryContractsSetList()
            await this.specificationSetAllList()
            await this.directoryPartnersGetList({ parent: '' })
        },
    }
</script>
=======
