                ...
                <div class="c-supply-requisition-material__table-wrapper mt-2">
                    ...
                    <div v-else class="c-supply-requisition-material-table">
                        <table>
                            <thead>
                                <tr>
                                    <th width="7%">Позиция</th>
                                    <th>Название</th>
                                    <th width="5%">Ед. изм</th>
                                    <th width="10%">Колличество по заявке</th>
                                    <th width="8%">Заказанно</th>
                                    <th>Счета</th>
                                    <th>Коментарий</th>
                                </tr>
                            </thead>
                    ...
                    <footer class="c-supply-requisition-material-table__footer mt-3">
                        <div class="button-wrapper">
                            <button 
                                v-show="supplyRequisitionMaterialSelectedList.length != 0 & !supplyRequisitionMaterialIsAttachedInvoices"
    ...
    export default {
        ...
        data(){ 
            return {
                ...
                selectInvoiceProps: {},
                breadcrumb: [
                    { text: 'Заявки', href: '/crm/upravlenie/supply/requisitions' },
                ],
            }
        },
        components: {
        ...
        computed: {
            ...mapGetters({
                ...
                supplyRequisitionMaterialIsAttachedInvoices: 'supplyRequisitionMaterialIsAttachedInvoicesGetter',
        ...
        async mounted(){
            ...
            this.breadcrumb = [
                ...
                { text: this.supplyMyRequisition.number },
            ]
        }
    }
</script>
...
<script>
    ...
    export default {
        ...
        async mounted(){
            ...
            this.breadcrumb = [
                { text: 'Заявки', to: '/upravlenie/requisitions/all' },
                { text: this.supplyMyRequisition.number },
            ]
        }
    }
