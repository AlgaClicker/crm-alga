...
return [
    ...
    */
    ...
    'in'                   => 'Выбранное значение для :attribute ошибочно. Должно быть одно из [:values]',
    ...
    'uuid'                 => 'Поле :attribute должно быть в формате UUID',
    'missing'              => 'Поле :attribute не должно присудствовать',
    /*
    |--------------------------------------------------------------------------
